...
$main_area->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h2 class="" style="text-align: center;">SCHLIESSE DICH DER WELLNESS-REVOLUTION AN</h2>',
    'type' => 'PlainTxtModel',
...
<h2 class="" style="text-align: center;">SCHLIESSE DICH DER WELLNESS-REVOLUTION AN</h2>
...
$main_area->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'usingNewAppearance' => true,
    'content' => '<h3 style="text-align: center;">Erfahre wie Du Körper und Geist in Einklang bringst, sich aus purer Freude bewegen, gut aussehen und sich mit allem verbunden fühlen, was das Leben zu bieten hat.</h3>',
    'type' => 'PlainTxtModel',
...
<h3 style="text-align: center;">Erfahre wie Du Körper und Geist in Einklang bringst, sich aus purer Freude bewegen, gut aussehen und sich mit allem verbunden fühlen, was das Leben zu bieten hat.</h3>
...
$region_9->add_element("PlainTxt", array (
  ...
  array (
    'view_class' => 'PlainTxtView',
    'id_slug' => 'plain_text',
    'content' => '<h5 style="text-align: center;"><span class="upfront_theme_color_7">SCHLIESSE DICH DER WELLNESS-REVOLUTION AN</span></h5>',
    'type' => 'PlainTxtModel',
    'usingNewAppearance' => true,
...
<h5 style="text-align: center;"><span class="upfront_theme_color_7">SCHLIESSE DICH DER WELLNESS-REVOLUTION AN</span></h5>
...
$region_9->add_element("PlainTxt", array (
  ...
  array (
    'view_class' => 'PlainTxtView',
    'id_slug' => 'plain_text',
    'content' => '<p style="text-align: center;">Erhalte eine wöchentliche Portion Motivation, Rezepte und <strong data-redactor-tag="strong" data-verified="redactor"><span class="upfront_theme_color_0">KOSTENLOSE</span></strong> Ressourcen direkt in Deinen Posteingang.</p>',
    'type' => 'PlainTxtModel',
    'usingNewAppearance' => true,
...
<p style="text-align: center;">Erhalte eine wöchentliche Portion Motivation, Rezepte und <strong data-redactor-tag="strong" data-verified="redactor"><span class="upfront_theme_color_0">KOSTENLOSE</span></strong> Ressourcen direkt in Deinen Posteingang.</p>
...
$region_9->add_element("Code", array (
  ...
  array (
    ...
    <input type="email" name="user-email" placeholder="E-Mail-Addresse">
