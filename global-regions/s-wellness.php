...
$s_wellness->add_element("PlainTxt", array (
  ...
  array (
    ...
    'id_slug' => 'plain_text',
    'content' => '<h5 style="text-align: left;">WOHLBEFINDEN AM ARBEITSPLATZ</h5>',
    'type' => 'PlainTxtModel',
...
<h5 style="text-align: left;">WOHLBEFINDEN AM ARBEITSPLATZ</h5>
...
$s_wellness->add_element("Button", array (
  ...
  array (
	...
	<div class="upfront-object-content upfront-output-ubutton">
		<a href="{{upfront:home_url}}/services/" target="" style="text-align: center;" class="button-style upfront_cta button-preset-default ueditable-inactive uf-click-to-edit-text" title="Double click to edit the text">FINDE MEHR HERAUS</a>
	</div>
<b class="upfront-resize-handle-element"></b><b class="upfront-resize-handle-element upfront-resize-handle-element-right"></b></div>
<div class="upfront-entity-size-hint upfront-ui"></div>',
  ),
